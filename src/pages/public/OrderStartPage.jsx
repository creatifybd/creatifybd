...
const OrderStartPage = () => {
  ...
  const [websiteRequirements, setWebsiteRequirements] = useState({
    businessType: '',
    pagesNeeded: '',
    contentAvailability: 'ready', // ready, draft, need-help
    competitorWebsites: '',
    hostingStatus: '',
    featuresNeeded: ''
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (requirementFile) {
        ...
        const fileName = `order-requirements/${Date.now()}_${requirementFile.name}`;
      ...
      // Consolidate category specific fields
      let catSpecific = {};
      if (gig.category === 'social-media-management') {
        catSpecific = smmRequirements;
      } else if (gig.slug.includes('logo')) {
        catSpecific = logoRequirements;
      } else if (gig.slug.includes('thumbnail')) {
        catSpecific = thumbnailRequirements;
      } else if (gig.category === 'website-design') {
  ...
  return (
    <div className="order-start-page">
        ...
        <div className="order-flow-layout">
          ...
          <div className="order-form-column">
            <div className="order-form-card">
              ...
              <p className="form-sub-intro">
                Tell us about your project goal. Our team uses these details as the strategy blueprint.
              </p>
              ...
              <form onSubmit={handleSubmit} className="intake-form">
                  ...
                  <div className="form-row-2">
                    ...
                    <div className="form-group">
                      ...
                      <input 
                        ...
                        value={clientDetails.websiteLinks}
                        onChange={e => setClientDetails({...clientDetails, websiteLinks: e.target.value})}
                      />
                    </div>
                  </div>
                </div>
                ...
                <div className="form-section-block">
                    ...
                    <div className="cat-inputs-wrapper">
                      <div className="form-group">
                        ...
                        <input 
                          ...
                          value={smmRequirements.platforms}
                          onChange={e => setSmmRequirements({...smmRequirements, platforms: e.target.value})}
                        />
                      </div>
                      <div className="form-row-2">
                        <div className="form-group">
                          ...
                          <input 
                            ...
                            required
                            className="luxury-input"
                            placeholder="e.g. 3 posts per week, 5 posts per week"
                            value={smmRequirements.postingFrequency}
                            onChange={e => setSmmRequirements({...smmRequirements, postingFrequency: e.target.value})}
                          />
                        </div>
                        <div className="form-group">
                          <label htmlFor="smm-goals">What is your primary monthly goal? *</label>
                          <input 
                            id="smm-goals"
                            type="text" 
                            required
                            ...
                            value={smmRequirements.monthlyGoal}
                            onChange={e => setSmmRequirements({...smmRequirements, monthlyGoal: e.target.value})}
                          />
                        </div>
                      </div>
                      <div className="form-group">
                        ...
                        <textarea 
                          ...
                          className="luxury-input"
                          style={{ height: '80px' }}
                          placeholder="Provide page links or competitor usernames..."
                          value={smmRequirements.competitors}
                          onChange={e => setSmmRequirements({...smmRequirements, competitors: e.target.value})}
                        />
                      </div>
                    </div>
                  )}
                      ...
                      <div className="form-row-2">
                        <div className="form-group">
                          ...
                          <input 
                            ...
                            required
                            className="luxury-input"
                            placeholder="e.g. Creatify"
                            value={logoRequirements.logoText}
                            onChange={e => setLogoRequirements({...logoRequirements, logoText: e.target.value})}
                          />
                        </div>
                        <div className="form-group">
                          ...
                          <input 
                            ...
                            type="text"
                            className="luxury-input"
                            placeholder="e.g. Design. Strategy. Growth."
                            value={logoRequirements.slogan}
                            onChange={e => setLogoRequirements({...logoRequirements, slogan: e.target.value})}
                          />
                        </div>
                      </div>
                      <div className="form-row-2">
                        <div className="form-group">
                          ...
                          <input 
                            ...
                            required
                            className="luxury-input"
                            placeholder="e.g. Deep crimson red, charcoal black, white"
                            value={logoRequirements.preferredColors}
                            onChange={e => setLogoRequirements({...logoRequirements, preferredColors: e.target.value})}
                          />
                        </div>
                        <div className="form-group">
                          ...
                          <input 
                            ...
                            required
                            className="luxury-input"
                            placeholder="e.g. Minimalist, Vector Emblem, Bold Wordmark"
                            value={logoRequirements.stylePreference}
                            onChange={e => setLogoRequirements({...logoRequirements, stylePreference: e.target.value})}
                          />
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="cat-inputs-wrapper">
                      <div className="form-group">
                        ...
                        <input 
                          ...
                          required
                          className="luxury-input"
                          placeholder="e.g. 5 MISTAKES that destroy startups"
                          value={thumbnailRequirements.videoTitle}
                          onChange={e => setThumbnailRequirements({...thumbnailRequirements, videoTitle: e.target.value})}
                        />
                      </div>
                      <div className="form-group">
                        ...
                        <input 
                          ...
                          required
                          className="luxury-input"
                          placeholder="e.g. Business coaching, tech review, stock trading"
                          value={thumbnailRequirements.topic}
                          onChange={e => setThumbnailRequirements({...thumbnailRequirements, topic: e.target.value})}
                        />
                      </div>
                    </div>
                  )}
                      ...
                      <div className="form-row-2">
                        <div className="form-group">
                          ...
                          <input 
                            ...
                            value={websiteRequirements.businessType}
                            onChange={e => setWebsiteRequirements({...websiteRequirements, businessType: e.target.value})}
                          />
                        </div>
                        <div className="form-group">
                          ...
                          <input 
                            ...
                            required
                            className="luxury-input"
                            placeholder="e.g. Home, Services, Pricing, About, Contact"
                            value={websiteRequirements.pagesNeeded}
                            onChange={e => setWebsiteRequirements({...websiteRequirements, pagesNeeded: e.target.value})}
                          />
                        </div>
                      </div>
                      <div className="form-group">
                        ...
                        <select 
                          id="web-content"
                          className="luxury-input"
                          value={websiteRequirements.contentAvailability}
                  ...
                  <div className="form-group" style={{ marginTop: '1.5rem' }}>
                    ...
                    <textarea 
                      ...
                      value={genericRequirements.projectGoal}
                      onChange={e => setGenericRequirements({...genericRequirements, projectGoal: e.target.value})}
                    />
                  </div>
                  ...
                  <div className="form-row-2">
                    ...
                    <div className="form-group">
                      ...
                      <input 
                        ...
                        type="date"
                        className="luxury-input"
                        value={genericRequirements.deadline}
                        onChange={e => setGenericRequirements({...genericRequirements, deadline: e.target.value})}
                ...
                <div className="form-section-block">
                  ...
                  <div className="form-group">
                    <label>Upload Brand Guidelines, Logos, Copy drafts or Reference Files (Max 10MB)</label>
                    <div className="file-upload-wrapper">
                      ...
                      <label htmlFor="requirement-file" className="file-upload-label">
                        <Upload size={22} />
                        <span>
                          {requirementFile ? requirementFile.name : 'Drag & drop or browse files (ZIP, PDF, DOC, JPG, PNG)'}
                        </span>
                      </label>
                    </div>
                  </div>
                ...
                <button 
                  type="submit" 
                  disabled={loading} 
                  className="btn-huge-red w-full justify-center"
            ...
            <div className="order-summary-sidebar">
              ...
              <div className="guarantees-list">
                <div className="g-item">
                  ...
                  <span>Verified Escrow Order Lock</span>
                </div>
                <div className="g-item">
                  <CheckCircle2 size={15} />
                ...
                <div className="g-item">
                  <CheckCircle2 size={15} />
                  <span>Dedicated PM Channel</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <style>{`
        ...
        .price-row-item.total .lbl {
          color: white;
          font-weight: 800;
        }

        .price-row-item.total .val {
          color: var(--red);
          font-weight: 800;
        }
