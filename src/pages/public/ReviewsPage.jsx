  ...
  >
    ...
    {review.gigTitle && (
      <div className="rc-service-tag">
        <span>সার্ভিস: {review.gigTitle}</span>
      </div>
    )}
  </motion.div>
);
...
const ReviewsPage = () => {
  ...
  const countries = [
    'all',
    ...Array.from(new Set(reviews.map(r => r.country).filter(Boolean))),
  ];
  ...
  const stats = [
    { num: avgRating.toFixed(1), label: 'গড় রেটিং', extra: <StarDisplay rating={5} /> },
    { num: `${reviews.length}+`, label: 'মোট রিভিউ' },
    { num: `${Math.round((fiveStarCount / reviews.length) * 100)}%`, label: '৫-স্টার রেটিং' },
  ];

  const seo = usePageSEO('reviews', {
    title: "ক্লায়েন্ট রিভিউ — CreatifyBD",
    description: "বাংলাদেশের বিভিন্ন ব্র্যান্ড ও উদ্যোক্তাদের সাথে আমাদের কাজের বাস্তব অভিজ্ঞতা ও মতামত।"
  });
    ...
    <div className="reviews-page-pub">
      ...
      <section className="reviews-hero reviews-hero-light">
        <div className="container">
          ...
          >
            আমাদের ক্লায়েন্টদের <span className="red">প্রকৃত রিভিউ</span>
          </motion.h1>
          ...
          >
            বাংলাদেশের বিভিন্ন ব্র্যান্ড ও উদ্যোক্তাদের সাথে আমাদের কাজের বাস্তব অভিজ্ঞতা ও মূল্যায়ন—সরাসরি তাদের ভাষায়।
          </motion.p>
      ...
      <section className="review-workflow-band" aria-label="Verified review workflow">
        <div className="container">
          <div className="review-workflow-row">
            {[
              'প্রজেক্ট ব্রিফ ও আলোচনা',
              'ডিজাইন ও প্রোডাকশন',
              'রিভিউ ও ফিডব্যাক',
              'সফল ডেলিভারি ও সন্তুষ্টি',
            ].map((item, index) => (
