...
export const CURATED_PORTFOLIO = [
  ...
  ...makeItems('social', [
    ...
    'TechHaat BD Mega Gadget Sale Ad Campaign',
    'Dhaka Spice Authentic Biryani Promo Poster',
    'SmileCraft Dental Care Smile Makeover Ad',
    'Urban Nest Luxury Dream Apartment Campaign',
    'Rongin Attire Premium Eid Collection Campaign',
    'NextStep Academy Admission Open Social Campaign',
    'Blue Bay Travels Coxs Bazar Holiday Tour Poster',
    'Shobuj Bazar Fresh Farm to Home Organic Food Ad',
    'HomeAura Modern Living Premium Furniture Campaign',
    'Glow & Grace Salon Bridal Makeover Offer Creative'
  ], [
    'Travel',
    'Wellness',
    'Coffee',
    ...
    'Restaurant & Gourmet Dining',
    'Healthcare & Dental Clinic',
    'Real Estate & Luxury Apartments',
    'Fashion & Traditional Apparel',
    'Academic & Coaching Academy',
    'Tourism & Travel Holiday',
    'Organic Grocery & Farm Fresh',
