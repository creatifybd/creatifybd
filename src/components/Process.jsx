...
const defaultSteps = [
  {
    num: '০১',
    title: 'প্রজেক্ট আলোচনা ও ব্রিফিং',
    desc: 'আপনার ব্র্যান্ডের লক্ষ্য, টার্গেট কাস্টমার এবং প্রজেক্টের প্রয়োজনীয়তা বিস্তারিত জেনে নেওয়া।',
  },
  {
    num: '০২',
    title: 'স্ট্র্যাটেজি ও প্ল্যানিং',
    desc: 'কাজের ক্রিয়েটিভ ডিরেকশন, কনটেন্ট রোডম্যাপ ও সময়সীমা চূড়ান্ত করা।',
  },
  {
    num: '০৩',
    title: 'ক্রিয়েটিভ প্রোডাকশন',
    desc: 'আমাদের অভিজ্ঞ ডিজাইনার, ভিডিও এডিটর ও ডেভেলপার টিম মূল কাজ তৈরি শুরু করে।',
  },
  {
    num: '০৪',
    title: 'রিভিউ ও ফিডব্যাক',
    desc: 'আপনার মতামতের ভিত্তিতে প্রয়োজন অনুযায়ী নিখুঁত রিভিশন ও ফাইনাল টাচ দেওয়া।',
  },
  {
    num: '০৫',
    title: 'হ্যান্ডওভার ও সাপোর্ট',
    desc: 'সম্পূর্ণ হাই-রেজোলিউশন ও সোর্স ফাইল ডেলিভারি এবং প্রজেক্ট পরবর্তী প্রয়োজনীয় সাপোর্ট।',
  },
];
...
const Process = ({ highlight = false, fullPage = false }) => {
  ...
  const titleText = globalizeCopy(
    ...
    'প্রথম আলোচনা থেকে <span class="text-red">ফাইনাল ডেলিভারি</span> — ৫টি সহজ ধাপ'
  );
  const subtitleText = globalizeCopy(
    processContent.subtitle,
    'প্রতিটি প্রজেক্টে থাকে স্পষ্ট কাজের রোডম্যাপ, যাতে আপনি সবসময় জানেন আপনার কাজ কোন পর্যায়ে আছে।'
  );
    ...
    <section className={`process-new-section section${fullPage ? ' full-page-section' : ''}`} id="process">
      <div className="container">
        ...
        {highlight && (
          ...
          >
            <Link to="/contact" className="btn-red">আপনার প্রজেক্ট শুরু করুন →</Link>
          </motion.div>
        )}
      </div>
