...
const CTABand = () => {
  ...
  const headline = cta.title || 'একটি Message-এ শুরু করুন';
  const subtext  = cta.subtitle  || "কোনো lengthy onboarding নেই, কোনো hidden charge নেই — শুধু আপনার project-এর কথা বলুন এবং আমরা দ্রুত quote দেব।";
  const ctaLabel = cta.primary_btn || "Start a Project";
  const ctaLink  = cta.primary_link || "/contact";
  const secondaryLabel = cta.secondary_btn || "💬 Chat on WhatsApp";
  const secondaryLink  = cta.secondary_link || `https://wa.me/8801951676600?text=${encodeURIComponent('Hello CreatifyBD! আমি একটি project নিয়ে কথা বলতে চাই।')}`;
      ...
      <div className="container">
        ...
        >
          ...
          >
            ...
            <a href={secondaryLink} className="ctaband-btn-ghost" target={secondaryLink.startsWith('http') ? '_blank' : '_self'} rel="noreferrer">
              {secondaryLabel}
            </a>
          </motion.div>
        </motion.div>
