...
const Hero = () => {
  ...
  const heroImage    = heroContent.mockup_primary || '/assets/hero-agency-showcase-v2.png';
          ...
          <div className="hero-img-single">
            <motion.div style={{ y: y2 }}>
              <img
                ...
                fetchPriority="high"
                onError={(e) => {
                  if (e.target.src !== '/assets/hero-agency-showcase-v2.png') {
                    e.target.src = '/assets/hero-agency-showcase-v2.png';
                  }
                }}
              />
            </motion.div>
