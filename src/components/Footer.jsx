      ...
      <div className="container">
        ...
        <div className="footer-top">
          ...
          >
            ...
            <div className="footer-newsletter">
              <p className="footer-newsletter-label">ডিজাইন টিপস ও গ্রোথ আপডেট</p>
          ...
          >
            ...
            <div className="footer-contact-list">
              ...
              <div className="footer-contact-item">
                <small>হোয়াটসঅ্যাপ</small>
                <a href={`https://wa.me/${siteConfig.whatsappNumber?.replace(/\D/g, '')}`} target="_blank" rel="noreferrer">
                  সরাসরি মেসেজ দিন <ArrowUpRight size={12} />
                </a>
              </div>
              <div className="footer-contact-item">
                <small>রেসপন্স টাইম</small>
                <span>২৪ ঘণ্টার মধ্যে</span>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="footer-bottom">
          <p className="footer-copy">
            © {new Date().getFullYear()} CreatifyBD। সর্বস্বত্ব সংরক্ষিত। 🇧🇩
          </p>
          <div className="footer-legal">
            <Link to="/privacy">গোপনীয়তা নীতি</Link>
            <Link to="/terms">ব্যবহারের শর্তাবলী</Link>
            <Link to="/refund-policy">রিফান্ড পলিসি</Link>
          </div>
        </div>
      </div>
