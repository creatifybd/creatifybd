...
// NOTE: this component is not currently rendered on any page (verified — no
// import/usage found across src/pages). Left in place for potential future
// use as a real-client-logo strip once real client logos are available via
// the admin panel, but intentionally shipped with an empty list rather than
...
const Clients = () => {
  ...
  return (
    <section className="cl2-section" aria-label="Trusted by Bangladeshi brands">
      {/* Header */}
      <motion.div
      ...
      >
        <div className="cl2-title-row">
          ...
          <p className="cl2-label">বাংলাদেশের ব্র্যান্ড ও উদ্যোক্তাদের পছন্দের পার্টনার</p>
        </div>
        <div className="cl2-count-row">
          <span className="cl2-count">২০০<span className="cl2-plus">+</span></span>
          <span className="cl2-count-label">সফল প্রজেক্ট ডেলিভারি</span>
        </div>
      </motion.div>
