...
// that showed office/team photography; that visual treatment was removed
// but the variables were never cleaned up. Kept only as real local image
// paths (never external stock) in case a future version of this section
// wants them again — currently unused.
...
const AboutTrust = () => {
  ...
  const stats = Array.isArray(aboutContent.stats) && aboutContent.stats.length
    ? aboutContent.stats
    : defaultStats;
  const title = globalizeCopy(aboutContent.title, 'একটি নিবেদিত ক্রিয়েটিভ টিম — আপনার ব্র্যান্ডের <span class="text-red">নির্ভরযোগ্য সঙ্গী</span>');
  const subtitle = globalizeCopy(
    aboutContent.subtitle,
    'CreatifyBD উদ্যোক্তা ও ব্যবসায়ীদের দিচ্ছে ফুল-সার্ভিস ক্রিয়েটিভ সাপোর্ট—ইন-হাউস টিম রাখার অতিরিক্ত খরচ ও জটিলতা ছাড়াই।'
  );
            ...
            <div className="ab-ceo-card">
              <div className="ab-ceo-quote-body">
                ...
                <p className="ab-quote-text">
                  "{aboutContent.ceo_quote || 'আমাদের কাজ শুধু ডিজাইন করা নয়, প্রতিটি প্রজেক্টের মাধ্যমে আপনার ব্র্যান্ডকে দেশের বাজারে সবচেয়ে আকর্ষণীয় ও বিশ্বাসযোগ্য করে গড়ে তোলা।'}"
                </p>
                <div className="ab-ceo-meta">
                  <span className="ab-ceo-name">CreatifyBD টিম</span>
                </div>
              </div>
            </div>

            <Link to="/about" className="ab-cta-link">
              <span>{aboutContent.cta_label || 'আমাদের সম্পর্কে বিস্তারিত জানুন'}</span>
              <ArrowRight size={16} />
            </Link>
          </div>
          ...
          <div className="ab-visual-col">
            ...
            <div className="ab-model-card">
              <div className="ab-model-header">
                ...
                <strong>{aboutContent.team_heading || 'স্পেশালিস্ট ক্রিয়েটিভ টিম'}</strong>
              </div>
