...
/* ── Service categories ─────────────────────────────────────── */
const SERVICE_ITEMS = [
  { slug: 'social-media-management', label: 'সোশ্যাল মিডিয়া ম্যানেজমেন্ট', icon: <BarChart2 size={16} />, desc: 'কন্টেন্ট ক্যালেন্ডার, পোস্ট ও স্ট্র্যাটেজি' },
  { slug: 'graphic-design',          label: 'গ্রাফিক ডিজাইন ও ব্র্যান্ডিং',  icon: <Palette  size={16} />, desc: 'লোগো, ব্র্যান্ড আইডেন্টিটি ও ব্যানার' },
  { slug: 'video-editing',           label: 'ভিডিও এডিটিং ও রিলস',          icon: <Video    size={16} />, desc: 'শর্ট-ফর্ম রিলস, ইউটিউব ও প্রমোশন' },
  { slug: 'website-design',          label: 'ওয়েবসাইট ডিজাইন',             icon: <Globe2   size={16} />, desc: 'ল্যান্ডিং পেজ ও আধুনিক বিজনেস সাইট' },
];

const SERVICE_SUB_ROWS = [
  { slug: 'social-media-management', label: 'সোশ্যাল মিডিয়া পোস্ট',       icon: <Share2          size={15} /> },
  { slug: 'social-media-management', label: 'কন্টেন্ট ক্যালেন্ডার',        icon: <LayoutGrid      size={15} /> },
  { slug: 'graphic-design',          label: 'প্রফেশনাল লোগো ডিজাইন',      icon: <PenTool         size={15} /> },
  { slug: 'graphic-design',          label: 'ব্র্যান্ড আইডেন্টিটি',       icon: <Layers          size={15} /> },
  { slug: 'video-editing',           label: 'রিলস ও শর্ট ভিডিও',          icon: <Film            size={15} /> },
  { slug: 'video-editing',           label: 'ইউটিউব ভিডিও এডিটিং',        icon: <MousePointerClick size={15} /> },
  { slug: 'website-design',          label: 'হাই-কনভার্টিং ল্যান্ডিং পেজ', icon: <Monitor         size={15} /> },
  { slug: 'website-design',          label: 'বিজনেস ওয়েবসাইট',            icon: <Box             size={15} /> },
];
                      ...
                      >
                        <div className="nav-mega-body">
                          <div className="nav-mega-list">
                            <p className="nav-mega-section-label">আমাদের সার্ভিসসমূহ</p>
                        ...
                        <div className="nav-mega-footer">
                          <Link
                            ...
                            onClick={() => setPanelOpen(false)}
                          >
                            সব সার্ভিস একসাথে দেখুন
                            <ArrowUpRight size={13} />
                          </Link>
                          <span className="nav-mega-footer-tag">১০০% কোয়ালিটি নিশ্চয়তা · দ্রুত ডেলিভারি</span>
                        </div>
                      </motion.div>
                    )}
                  </AnimatePresence>
            ...
            >
                      ...
                      >
                        ...
                        <div style={{
                          ...
                          <Link to="/services" onClick={() => setMobileOpen(false)} style={{
                            ...
                            সব সার্ভিস দেখুন <ArrowUpRight size={12} />
                          </Link>
              ...
              <div style={{
                ...
                <p style={{ textAlign: 'center', fontSize: '0.67rem', color: '#bbb', margin: '8px 0 0' }}>
                  প্রিমিয়াম কোয়ালিটি · সাশ্রয়ী বাজেট
                </p>
              </div>
